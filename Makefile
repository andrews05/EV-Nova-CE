...
$(OUTPUT): $(LDS) $(INPUT) $(OBJS)
	$(LD) $(LDFLAGS) -T $(LDS) -o "$@" $(OBJS) $(CXXLIBS) $(LIBS) -L=/../lib/gcc/i686-w64-mingw32/$(GCCVERSION) -L/mingw32/lib/gcc/i686-w64-mingw32/$(GCCVERSION) -L./lib/gcc/i686-w64-mingw32/$(GCCVERSION)
ifneq (,$(IMPORTS))
